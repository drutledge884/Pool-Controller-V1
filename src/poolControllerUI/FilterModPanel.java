...
public class FilterModPanel extends JPanel 
{
	 ...
	 */
	public FilterModPanel(JFrame currentFrame, Pool pool) 
	{
		setLayout(null);
		...
		if(pool.getFilter().getActive())
			lblNewLabel2 = new JLabel("Filter Status: On");
		else
			lblNewLabel2 = new JLabel("Filter Status: Off");
		...
		add(lblNewLabel2);
		//turn filter on
		btnNewButton_1 = new JButton("Filter On");
		btnNewButton_1.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				currentFrame.getContentPane().add(new FilterModPanel(currentFrame, pool));
		...
		add(btnNewButton_1);
		//turn filter off
		btnNewButton_2 = new JButton("Filter Off");
		...
		add(btnNewButton_3);
		//display run time
		String lblStr = new String("Run Time: " + pool.getFilter().toString());
